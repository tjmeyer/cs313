<?php
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST")
   {
            ...
            $errorArray['password_confirm'] == $goodEntry)
      {
         ...
         $_POST['password'] = password_hash($entryArray['password'], PASSWORD_DEFAULT);
         createUser($db, $_POST, TRUE); //Where TRUE is stating that it is a master user
         $_SESSION['user'] = $entryArray['username'];
...
<html lang="en">
<head>
	<title>CellSpan - New Account</title>
   <meta charset="utf-8">
   ...
   <div class="row">
         ...
         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="create_account">
            ...
            <div class="row">
               ...
               <div class="col-sm-6">
                  <input type="password" class="form-control input-lg" name="password" maxlength="50" placeholder="Password" value="<?php echo $entryArray['password'];?>"/>
               </div>
               <div class="col-sm-4">
